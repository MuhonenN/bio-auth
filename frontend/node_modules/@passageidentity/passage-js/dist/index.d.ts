...
declare type identifier = keyof typeof Identifier;
...
declare enum PassageUserStatusEnum {
    Active = "active",
    Inactive = "inactive",
    Pending = "pending"
}
declare type PassageUserStatus = keyof typeof PassageUserStatusEnum;
...
declare class User {
     ...
     */
    changeEmail(newEmail: string): Promise<PassageMagicLinkRequest>;
    /**
     ...
     * @return {PassageMagicLinkRequest} the magicLink response on success.
     */
    changePhone(newPhone: string): Promise<PassageMagicLinkRequest>;
    /**
...
declare class Passage {
     ...
     */
    newRegisterMagicLink(identifier: string): Promise<PassageMagicLinkRequest>;
    /**
     * Initiate new login with Passage Magic Link
     * @param {string} identifier The Passage User's identifier
     * @return {Promise<PassageMagicLinkRequest>} MagicLink JSON payload
     */
    newLoginMagicLink(identifier: string): Promise<PassageMagicLinkRequest>;
    /**
...
export { Identifier, Passage, PassageAppInfo, PassageError, PassageErrorCode, PassageMagicLinkRequest, PassageUser, PassageUserInfo, PassageUserStatus, PassageUserStatusEnum, User, authResult, identifier };
